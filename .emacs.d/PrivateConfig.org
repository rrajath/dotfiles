...
- [[#current-issues][Current Issues]]
  ...
  - [[#redo-doesnt-work][Redo doesn't work]]
...
- [[#work][Work]]
  - [[#excorporate-unused][Excorporate (unused)]]
    - [[#setup][Setup]]
...
I can only undo, but I have to set something up for redo. Packages to explore - undo-tree
* First things first
** Startup Performance
