...
** Excorporate
*** Setup
This needs initial setup of work account so that it can access the calendar. This can be done using =M-x excorporate=.
...
- emacs-dwim
- org-web-tools
- popper - use this for excorporate, help-mode, compilation-mode, messages, output buffers, vterm (check 1h24m in to the video)
* Runtime Performance
