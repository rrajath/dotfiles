...
#+begin_src shell
  abbr -a ls eza -l --color=always --group-directories-first # my preferred listing
  abbr -a la eza -a --color=always --group-directories-first  # all files and dirs
  abbr -a ll eza -l --color=always --group-directories-first  # long format
...
#+end_src
* direnv
Make sure to install [[https://github.com/direnv/direnv/tree/master][direnv]] first
